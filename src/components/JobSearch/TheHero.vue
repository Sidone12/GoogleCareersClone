...
<main class="flex h-screen flex-col">
    <section class="pt-10 pb-20" id="hero">
        <div class="grid grid-cols-12">
            ...
            <div class="col-span-5 col-start-7 self-center justify-self-center">
                <img class="h-80 w-80 object-contain" src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/95/Vue.js_Logo_2.svg/2367px-Vue.js_Logo_2.svg.png" alt="" />
            </div>
    ...
    <SpotLight class="flex flex-row justify-center pb-16">
        ...
        >
          ...
          <router-link
            to="/jobs/results"
            class="px-6 py-4 text-sm text-brand-blue-1"
